...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col justify-center px-4 md:px-16 pt-8 md:pt-12 pb-8 md:pb-0 overflow-x-hidden bg-bg text-ink lg:min-h-[70vh]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-x-0 inset-y-0 lg:left-1/4 flex items-center justify-center pointer-events-none overflow-hidden h-full">
          <motion.div 
            ...
            className="relative w-full h-full max-w-[1000px] mt-12 md:mt-0"
          >
            <img 
      ...
      <div className="z-10 relative w-full max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          <div className="mb-4 flex flex-col items-center gap-4 md:gap-6">
             <div className="h-[2px] w-24 bg-accent/30" />
          </div>

          <div className="relative mb-2 md:mb-4 px-2 w-full">
            <h1 className="text-[1.8rem] xs:text-[2.2rem] sm:text-6xl md:text-9xl font-black tracking-[0.1em] sm:tracking-[0.2em] uppercase text-white drop-shadow-[0_0_50px_rgba(230,30,30,0.2)] relative z-10 leading-[1] sm:leading-none break-words">
              P-THREAD
            </h1>
          </div>
